...
#define USE_ADV_EVENT			1 // =1 enable, 0 diseble
#define ADV_EVENT_TX_COUNT 		4 // tx count
#define ADV_EVENT_INTERVAL 		ADV_INTERVAL_50MS
#define DEF_ADV_INTERVAL_MIN	ADV_INTERVAL_300MS
#define DEF_ADV_INTERVAL_MAX	ADV_INTERVAL_305MS
#define DEF_DIRECT_ADV_TMIE		2000000

#define	BLE_DEVICE_ADDRESS_TYPE 			BLE_DEVICE_ADDRESS_PUBLIC
#define MTU_SIZE_SETTING 					64

#if(BLE_DEVICE_ADDRESS_TYPE == BLE_DEVICE_ADDRESS_PUBLIC)
#define app_own_address_type OWN_ADDRESS_PUBLIC
#elif(BLE_DEVICE_ADDRESS_TYPE == BLE_DEVICE_ADDRESS_RANDOM_STATIC)
#define app_own_address_type OWN_ADDRESS_RANDOM
#endif
...
typedef struct _adv_buf_t {
	...
	u8		scanRsp[2]; 	// = 0x0b, 0x09
	u8		devName[10];	// "Z2B_000000"
}adv_buf_t;
